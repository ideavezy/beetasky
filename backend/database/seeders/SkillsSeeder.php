    ...
    public function run(): void
    {
        ...
        $mcpSkills = [
            ...
            [
                ...
                'name' => 'Update Project',
                'slug' => 'update_project',
                'description' => 'Update a project. Find by project_id OR search by name. If multiple matches, returns list for user to choose. Use selection param when user picks a number.',
                'icon' => 'FolderIcon',
                'skill_type' => 'mcp_tool',
                ...
                'input_schema' => [
                    'type' => 'object',
                    'properties' => [
                        'project_id' => ['type' => 'string', 'description' => 'The UUID of the project. Use when you have the exact ID.'],
                        'search' => ['type' => 'string', 'description' => 'Search for project by name. Use when you don\'t have project_id.'],
                        'selection' => ['type' => 'integer', 'description' => 'When user picks a number from previous search results (e.g., "1" or "the first one"), pass that number here WITH the original search term.'],
                        'name' => ['type' => 'string', 'description' => 'New project name. Optional.'],
                        'description' => ['type' => 'string', 'description' => 'New description. Optional.'],
                        'status' => ['type' => 'string', 'enum' => ['planning', 'active', 'on_hold', 'completed', 'cancelled'], 'description' => 'New status. Optional.'],
            ...
            [
                ...
                'name' => 'List Projects',
                'slug' => 'list_projects',
                'description' => 'List and search projects. Use search to find projects by name.',
                'icon' => 'FolderOpenIcon',
                'skill_type' => 'mcp_tool',
