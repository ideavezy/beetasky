...
import { X, UserPlus, Loader2, ChevronDown, Mail, Phone, Building2, Briefcase, Globe } from 'lucide-react'
...
export default function CreateContactModal({ companyId, onClose, onSuccess }: CreateContactModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setError(response.data.message || 'Failed to create contact')
      }
    } catch (err: any) {
      ...
      <div className="relative bg-base-200 rounded-2xl shadow-2xl w-full max-w-lg mx-4 overflow-hidden animate-in fade-in zoom-in-95 duration-200 max-h-[90vh] flex flex-col">
        ...
        <div className="flex items-center justify-between p-5 border-b border-base-300">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-semibold text-base-content">Add Contact</h2>
              <p className="text-sm text-base-content/60">Add a new contact to your CRM</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-5 overflow-y-auto flex-1">
          ...
          <div className="flex gap-3 mt-6">
            ...
            <button
              type="submit"
              disabled={isLoading || !formData.full_name.trim() || !selectedCompanyId}
